...
/**
 * @generated from protobuf message mg.tonymushah.kanamaru.example1.HelloRequest
 */
...
/**
 * @generated from protobuf message mg.tonymushah.kanamaru.example1.HelloResponse
 */
...
class HelloRequest$Type extends MessageType<HelloRequest> {
    constructor() {
        super("mg.tonymushah.kanamaru.example1.HelloRequest", [
...
/**
 * @generated MessageType for protobuf message mg.tonymushah.kanamaru.example1.HelloRequest
 */
export const HelloRequest = new HelloRequest$Type();
// @generated message type with reflection information, may provide speed optimized methods
class HelloResponse$Type extends MessageType<HelloResponse> {
    constructor() {
        super("mg.tonymushah.kanamaru.example1.HelloResponse", [
...
/**
 * @generated MessageType for protobuf message mg.tonymushah.kanamaru.example1.HelloResponse
 */
export const HelloResponse = new HelloResponse$Type();
/**
 * @generated ServiceType for protobuf service mg.tonymushah.kanamaru.example1.HelloService
 */
